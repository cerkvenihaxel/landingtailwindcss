    ...
    <div class="lg:grid lg:grid-cols-12">
      ...
      <div class="relative bg-blue-600 lg:col-span-10 lg:col-start-3 lg:row-start-1 lg:grid lg:grid-cols-10 lg:items-center lg:rounded-3xl">
        ...
        <div class="relative mx-auto max-w-md space-y-6 py-12 px-4 sm:max-w-3xl sm:py-16 sm:px-6 lg:col-span-6 lg:col-start-4 lg:max-w-none lg:p-0">
          <h2 class="text-3xl font-bold tracking-tight text-white" id="join-heading">Sumate a nosotros</h2>
          <p class="text-lg text-white">Estamos en constante crecimiento y es por ello que puede haber un lugar para vos.</p>
          <a class="block w-full rounded-md border border-transparent bg-white py-3 px-5 text-center text-base font-medium text-blue-700 shadow-md hover:bg-gray-50 sm:inline-block sm:w-auto" href="#">Ver puestos disponibles</a>
        </div>
      </div>
    </div>
  </div>
